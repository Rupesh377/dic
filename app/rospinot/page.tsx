...
const domains = [
  { label: 'Autonomous Systems', icon: Cpu },
  { label: 'Computer Vision', icon: Eye },
  { label: 'AI/ML', icon: Bot },
  { label: 'Embedded', icon: Cog },
]
      ...
      <main className="relative z-10 min-h-screen">
          ...
          <div className="relative max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-3xl">
              <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-6">
                ...
                <span className="text-muted-foreground font-normal"> — Robotics Club</span>
              </h1>
              <p className="text-lg text-muted-foreground mb-6 max-w-2xl">
                <BlurText
                  text="Developing autonomous systems, robotics, and AI-driven innovations. Our team competes in international robotics competitions and builds intelligent machines."
                  delay={70}
                  animateBy="words"
                  direction="top"
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-secondary/10">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-muted-foreground text-center mb-12 max-w-xl mx-auto">
              Focus areas that define our robotics and AI journey
            </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-secondary/10">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-muted-foreground mb-12">Our work in Robotics & AI/ML</p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {['Robot Wars', 'Robotics Race', 'Workshops'].map((a) => (
                <div
                  key={a}
                ...
                >
                  ...
                  <h3 className="font-bold text-foreground text-lg">{a}</h3>
                </div>
              ))}
            </div>
          </div>
